...
# ============================================================================
# 4. YOUTUBE API FUNCTIONS
# ============================================================================
def get_comments(youtube, video_id, max_results):
    """
    Retrieves top-level comments from a YouTube video.
    Note: This simplified version does not retrieve threaded replies to keep the
    data structure flat and focused on primary reactions.
    """
    comments = []
...
# ============================================================================
def main():
    """Main function to execute the scraper workflow."""
    print("=" * 50)
    ...
    if not comments:
        print("\n✗ No comments collected. Check API key, Video ID, and quotas.")
        return
